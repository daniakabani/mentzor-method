"use strict";exports.id=481,exports.ids=[481],exports.modules={8481:(e,t,s)=>{s.d(t,{N:()=>r,Y:()=>o});let o=[{slug:"back-workout",title:"Mike Mentzer Back Workout Routine: Heavy Duty Training for Maximum Growth",description:"Build a wide, thick back with low-volume, high-intensity HIT. Exercises, sets, reps, and frequency.",tags:["mike mentzer","back workout","heavy duty","HIT"],html:`
  <article>
    <header>
...
`},{slug:"chest-workout",title:"Mike Mentzer Chest Workout Routine: Heavy Duty Training for Maximum Chest Growth",description:"Upper-chest focused, low-volume routine with pre-exhaust options and intensity techniques.",tags:["mike mentzer","chest workout","heavy duty","HIT"],html:`
  <article>
    <header>
      <h1>Mike Mentzer Chest Workout Routine: Heavy Duty Training for Maximum Chest Growth</h1>
...
`},{slug:"arm-workout",title:"Mike Mentzer Arm Workout Routine: Heavy Duty Training for Bigger Biceps and Triceps",description:"Few precise sets taken past comfort — strict curls, heavy close-grip pressing, and smart isolation.",tags:["mike mentzer","arm workout","heavy duty","HIT"],html:`
  <article>
    <header>
...
`},{slug:"leg-workout",title:"Mike Mentzer Leg Workout Routine: Heavy Duty Training for Massive Leg Growth",description:"Short, savage sessions for quads, hamstrings, and calves with pre-exhaust and slow negatives.",tags:["mike mentzer","leg workout","heavy duty","HIT"],html:`
  <!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`}];function r(e){return o.find(t=>t.slug===e)}}};